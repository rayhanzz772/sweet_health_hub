...
class DiagnosisPatient extends StatefulWidget {
  const DiagnosisPatient({super.key});

  @override
  State<DiagnosisPatient> createState() => _DiagnosisPatientState();
}

class _DiagnosisPatientState extends State<DiagnosisPatient> {
  ...
  final TextEditingController patientdiagnosis = new TextEditingController();
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (clients != null) {
                  for (var complaintHistory in clients) {
                    ...
                    diagnosis = complaintHistory['diagnosis'];
